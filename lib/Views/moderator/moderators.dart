...
class _ModeratorsPageState extends State<ModeratorsPage>
  ...
  void showGenderBottomSheet(bool isCreator, String username) async {
          ...
          builder: (BuildContext context, StateSetter setModalState) {
            ...
            children.addAll([
              ...
              GestureDetector(
                onTap: () {
                  print('Row tapped');
                  showLeaveCommunityDialog(context, username);
                },
                child: Container(
                  height: 60, // specify the height of the container
                  child: Row(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                trailing: IconButton(
                  ...
                  onPressed: () {
                    showGenderBottomSheet(isCreator, username);
                  },
                ),
              );
            },
          ...
          content: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text('Remove U/$communityName', textAlign: TextAlign.left, style: TextStyle(fontWeight: FontWeight.bold)),
