...
class logicAPI {
  ...
  Future<Map<String, dynamic>> fetchCommunityData(String communityName) async {
    ...
    final response = await http.get(
      Uri.parse('$_baseUrl/api/r/${Uri.encodeComponent("Movies dignissimos")}'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
    );
  ...
  Future<List<Map<String, dynamic>>> fetchCommunityProfilePosts(String subreddit) async {
    final response = await http.get(Uri.parse('$_baseUrl/api/r/${Uri.encodeComponent("Movies dignissimos")}/hot' ));
