...
//       case 'hot':
//         List<PostHeader> fetchedPosts = await api.fetchCommunityProfilePosts(communityName, 'hot');
//         setState(() {
...
//         break;
//       case 'new':
//         List<PostHeader> fetchedPosts = await api.fetchCommunityProfilePosts(communityName, 'new');
//         setState(() {
//           posts = fetchedPosts; print("fetchedposts");
//           print("fetchedposts");
//           print(posts);
...
//         print(timeInterval);
//         if (timeInterval!<1){
//           List<PostHeader>? fetchedPosts = await api.fetchTopPosts(communityName, "now");
//           setState(() {
